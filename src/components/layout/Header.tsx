                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative" ref={popoverRef}>
                        ...
                        >
                            ...
                            {unreadCount > 0 && (
                                <span className="absolute -top-0.5 -right-0.5 min-w-4.5 h-4.5 bg-red-500 rounded-full flex items-center justify-center text-[10px] font-bold text-white px-1 shadow-sm border-2 border-white animate-fadeIn">
                                                    ...
                                                    >
                                                        <div className="shrink-0 mt-0.5">
                                                            {notification.actor && typeof notification.actor !== 'string' && notification.actor.avatar ? (
                                                                ...
                                                                <div className="relative">
                                                                    <div className="w-9 h-9 rounded-full bg-linear-to-br from-indigo-400 to-blue-500 text-white flex items-center justify-center text-xs font-semibold shadow-sm">
                    ...
                    {user?.avatar ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-linear-to-br from-blue-400 to-purple-500 text-white flex items-center justify-center text-sm font-semibold cursor-pointer" onClick={() => router.push('/profile')}>
                            {userInitials}
                        </div>
                    )}
                </div>
