                                        ...
                                        return (
                                            <div key={activity._id} className="flex items-start gap-3">
                                                {actor?.avatar ? (
                                                    ...
                                                    <div className="w-8 h-8 rounded-full bg-linear-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-white text-xs font-semibold shrink-0 shadow-sm">
                                                        {actorInitials}
                                                    </div>
                                                )}
