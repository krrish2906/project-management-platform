                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredProjects.map((project) => {
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-500 mb-4 line-clamp-2 min-h-10">{project.description || 'No description'}</p>
                                        ...
                                        <div className="flex -space-x-2">
                                            {project.members && project.members.slice(0, 4).map((member, idx) => {
                                                ...
                                                return (
                                                    <div
                                                        key={idx}
                                                        className="w-8 h-8 rounded-full bg-linear-to-br from-blue-500 to-cyan-400 flex items-center justify-center text-white text-xs font-bold border-2 border-white shadow-sm"
