    ...
    return (
        ...
        <div className="flex h-screen bg-gray-100 font-sans">
            ...
            <div className="flex-1 flex flex-col bg-white">
                                                                ...
                                                                if (callLinkMatch) {
                                                                    ...
                                                                    return (
                                                                        <div className="flex flex-col gap-2">
                                                                            ...
                                                                            <div 
                                                                                className="bg-white border border-gray-200 rounded-xl p-3 shadow-sm flex items-center gap-4 mt-1 cursor-pointer hover:border-blue-400 hover:shadow-md transition-all sm:min-w-70" 
                ...
                {replyingTo && (
                    <div className="bg-linear-to-r from-blue-50 via-indigo-50/50 to-transparent px-5 py-3 flex items-center gap-3 animate-slideDown">
                        <div className="w-0.75 h-10 bg-linear-to-b from-blue-500 to-indigo-500 rounded-full shrink-0"></div>
