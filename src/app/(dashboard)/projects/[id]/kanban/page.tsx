                ...
                <div className="px-8 py-4">
                    <div className="flex justify-between items-center mb-0">
                        <div className="flex items-center gap-4">
                            <div onClick={() => router.push(`/projects/${projectId}`)} className="w-9 h-9 rounded-lg bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/30 cursor-pointer">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {canEdit && (
                                <button
                                    ...
                                    className="px-5 py-2.5 bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl flex items-center gap-2 shadow-lg shadow-blue-500/30 transition-all font-medium cursor-pointer"
                                >
                                ...
                                <Droppable droppableId={col.id} key={col.id}>
                                    {(provided, snapshot) => (
                                        ...
                                        >
                                            ...
                                            <div className="space-y-3 flex-1 overflow-y-auto min-h-25">
                                                                    ...
                                                                    <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                                                                        ...
                                                                        {typeof task.assignee === 'object' && task.assignee && (
                                                                            task.assignee.avatar ? (
                                                                                ...
                                                                                <div className="w-6 h-6 rounded-full bg-linear-to-br from-blue-400 to-purple-500 flex items-center justify-center text-white text-[10px] font-bold ring-2 ring-white">
                        ...
                        <form onSubmit={handleAddTask} className="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-gray-900 placeholder:text-gray-500 min-h-20 resize-none"
