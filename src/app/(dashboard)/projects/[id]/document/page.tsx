...
import { useCollaboration, UserCursor } from '@/features/documents/hooks/useCollaboration';
            ...
            <header className="bg-white/80 backdrop-blur-lg border-b border-gray-200/50 px-6 py-4 sticky top-0 z-50">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-4">
                            <div
                                ...
                                className="w-9 h-9 rounded-lg bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/30 cursor-pointer"
                            >
                                <ArrowLeft className="w-5 h-5 text-white" />
                            </div>
                            <div className="flex flex-col">
                                <span className="text-2xl font-bold bg-linear-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">Document Editor</span>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-5 py-2.5 rounded-xl text-sm font-medium shadow-lg shadow-blue-500/30 transition-all hover:shadow-blue-500/40 cursor-pointer">
                        ...
                        <div className="flex items-center gap-2 pl-2 border-l-2 border-gray-200">
                            {user?.avatar ? (
                                ...
                                <div className="w-9 h-9 rounded-full bg-linear-to-br from-blue-400 to-purple-500 text-white flex items-center justify-center text-sm font-semibold cursor-pointer ml-2" onClick={() => router.push('/profile')}>
                                    {userInitials}
                                </div>
                            )}
                ...
                <div className="flex-1 flex flex-col bg-[#f8f9fa]">
                    ...
                    <div className="flex-1 overflow-y-auto flex justify-center py-8 px-4">
                        {viewingVersionId ? (
                            ...
                            <div className="w-full max-w-204 bg-white rounded-sm shadow-[0_1px_3px_rgba(0,0,0,0.12),0_1px_2px_rgba(0,0,0,0.06)] border border-gray-200/60" style={{ minHeight: '1056px' }}>
                                <div className="px-16 py-14 tiptap-wrapper">
                                    <EditorContent editor={editor} className="prose prose-blue max-w-none min-h-225 [&>.ProseMirror]:outline-none [&>.ProseMirror]:ring-0 [&>.ProseMirror]:border-none" />
                                </div>
                            </div>
                        )}
                    </div>
                        ...
                        versions.map((v) => (
                            <div key={v.id} className="bg-white rounded-xl border border-gray-200 p-4 transition-all hover:border-blue-300 shadow-sm">
                                <div className="flex items-start gap-3">
                                    <div className="w-8 h-8 rounded-full bg-linear-to-br from-blue-50 to-indigo-50 border border-blue-100 flex items-center justify-center text-blue-600 text-xs font-bold">
                                        {v.author.initials}
                                    </div>
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-gray-500 mb-3 truncate max-w-50">Snapshot created</p>
            ...
            <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end gap-3">
                {aiFabOpen && (
                    <div className="w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden animate-fadeIn origin-bottom-right">
                        <div className="bg-linear-to-r from-blue-50 to-indigo-50 px-4 py-3 border-b border-gray-100 flex items-center justify-between">
