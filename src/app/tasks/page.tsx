            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <div className="bg-white border-b border-gray-200 p-6 shrink-0">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            <h1 className="text-2xl font-bold bg-linear-to-r from-blue-700 to-blue-500 bg-clip-text text-transparent">Tasks</h1>
                                                    ...
                                                    {assignee ? (
                                                        <div className="flex items-center gap-2">
                                                            {assignee.avatar ? (
                                                                ...
                                                                <div className="w-6 h-6 rounded-full bg-linear-to-br from-blue-400 to-purple-500 text-white text-[10px] font-bold flex items-center justify-center">
