                            ...
                            <div className="relative z-10 bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3 pt-4">
                                        <div className="h-20 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 border border-gray-100">
                                            <div className="h-3 bg-gray-200 rounded w-3/4 mb-2"></div>
                                            <div className="h-2 bg-gray-200 rounded w-1/2"></div>
                                        </div>
                                        <div className="h-20 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-4 border border-gray-100">
                                            <div className="h-3 bg-gray-200 rounded w-2/3 mb-2"></div>
                                            <div className="h-2 bg-gray-200 rounded w-1/3"></div>
                                        </div>
                                        <div className="h-20 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 border border-gray-100">
