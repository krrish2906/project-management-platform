        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200/50 p-6 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                {members.map((member) => (
                    <div
                        key={member.user._id}
                        className="group flex items-center gap-4 p-4 bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200/50 hover:shadow-md hover:border-blue-200 transition-all cursor-pointer"
                    >
