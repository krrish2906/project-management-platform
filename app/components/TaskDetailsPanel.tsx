                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg">
                        {assignee ? (
                            <>
                                {assignee.avatar ? (
                                    <img src={assignee.avatar} alt={assignee.name} className="w-8 h-8 rounded-lg outline outline-1 outline-gray-200" />
                                ) : (
                        ...
                        {reporter ? (
                            <>
                                {(reporter as any).avatar ? (
                                    <img src={(reporter as any).avatar} alt={(reporter as any).name} className="w-8 h-8 rounded-lg outline outline-1 outline-gray-200" />
                                ) : (
                                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center text-white text-xs font-bold">
